...
<div class="content">
	<div style="height: 60px;left: 45%; position: absolute; padding-left: 20px; font-size: 40px;">
			<b>Form thêm nhân viên rạp <?php echo $idrap;?></b>
	</div>
	<br> <br>
	<hr/>
	<form action="/admin/themnhanvien" method="POST" id="formthem">
		{{ csrf_field() }}
		<div class="row">
			<div class="col-md-2">
				Họ tên:
		...
		<div class="row">
			...
			<div class="col-md-6">
				<input type="text" value="<?php echo $idrap;?>" class="form-control" required="required" disabled="disabled">
