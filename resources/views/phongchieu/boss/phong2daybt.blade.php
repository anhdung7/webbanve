...
<div class="content">
  <div class="row">
      ...
      <div class="col-md-5">
        <div style="height: 45px;"><a href="/boss/botriphong" class="btn btn-primary" style="left: 60%; position: absolute;padding-left: 20px; padding-right: 20px; margin-top: 15px;">Trở về</a></div>
      </div>
    </div>
  <hr/>
