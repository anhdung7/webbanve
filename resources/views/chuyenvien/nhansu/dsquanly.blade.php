...
@section('contentchuyenvien')
	<div class="content">
		...
		<br>
		<a href="/chuyenvien/formthemql" class="btn btn-primary" style="left: 50%; position: absolute;padding-left: 20px; padding-right: 20px;">Thêm quản lý</a>
		<br>
		<br>
		<table class="table">
			<thead>
...
<script>
	function xoa(id)
	{
			...
			if(a==true)
			{
				var linkxoa='/chuyenvien/xoaquanly?id='+id;
