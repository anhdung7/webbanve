...
<div class="content">
	<br>
	<form action="/nhanvien/timinhoadonsdt">
	<div class="row">
		<div class="col-md-6"><h2>Danh sách các hóa đơn để in</h2></div>
				...
				<?php
					foreach ($dshoadon as $key => $value) {
						...
						<tr>
							...
							<td><button class="btn btn-primary" id="<?php echo $value->id;?>" name="inhoadon" onclick="inhoadon(this.id)">In</button></td>
						</tr>
						<?php
					}
				?>
...
<script>
	function inhoadon(id)
	{
			...
			if(a==true)
			{
				var link='/nhanvien/inhoadon?idhoadon='+id;
