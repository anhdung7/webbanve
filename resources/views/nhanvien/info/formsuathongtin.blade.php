...
<div class="content">
	...
	<div class="row">
		...
		<hr>
		<form action="/nhanvien/suathongtin" method="post">
			{{ csrf_field() }}
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-2">Tên:</div>
				<div class="col-md-6"><input type="text" name="name" class="form-control" value="<?php echo $nhanvieninfo[0]->name;?>" required="required"></div>
			</div>
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-2">Ngày sinh:</div>
				<?php
					$date = $nhanvieninfo[0]->birthday;
			...
			<div class="row">
				...
				<div class="col-md-6"><input type="text" name="phone" class="form-control" value="<?php echo $nhanvieninfo[0]->phone;?>" required="required"></div>
			</div>
			<div class="row">
				<div class="col-md-1"></div>
				<div class="col-md-2">Địa chỉ:</div>
				<div class="col-md-6"><input type="text" name="address" class="form-control" value="<?php echo $nhanvieninfo[0]->address;?>" required="required"></div>
			</div>
			<div class="row">
